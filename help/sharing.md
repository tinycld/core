...
Share links live outside the org-scoped URL tree and don't require an org context. They're read-only by default; some packages also support edit-permission links for collaborators. The exact URL shape depends on the package — see that package's own help for details.
